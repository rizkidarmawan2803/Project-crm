            ...
            {dealToDelete && (
                <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/50 px-4">
                    <div className="bg-white rounded-3xl p-6 w-full max-w-sm text-center shadow-xl animate-in fade-in zoom-in-95">
                        ...
                        <h3 className="text-[18px] font-bold text-gray-900 mb-2">Hapus Dokumen Deal?</h3>
                        <p className="text-[13px] text-gray-500 mb-6 leading-relaxed">
                            Apakah Anda yakin ingin menghapus dokumen transaksi ini? Tindakan ini tidak dapat dibatalkan.
                        </p>
                        <div className="flex gap-3 justify-center">
                            <button onClick={() => setDealToDelete(null)} className="flex-1 px-4 py-2.5 rounded-xl text-gray-700 bg-gray-100 hover:bg-gray-200 font-semibold text-[13px] transition">
                                Batal
                            </button>
