...
const AVATAR_COLORS = [
    "#e8630a", "#7c3aed", "#1d4ed8",
    "#0f766e", "#be185d", "#0369a1",
];
                ...
                <div className="bg-white rounded-xl border border-gray-200 overflow-hidden mb-4">
                    <div className="overflow-x-auto">
                        <table className="w-full text-[13px] min-w-[860px]">
                            <thead className="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    {["Nama / Perusahaan", "Kontak", "Sumber", "Status", "Domisili", "Sales PIC", "Tgl Dibuat", "Aksi"].map((h) => (
                                        <th key={h} className="px-3.5 py-2.5 text-left text-[11.5px] uppercase tracking-wide text-gray-500 font-medium whitespace-nowrap">
                                            {h}
                                        </th>
                                    ))}
                                </tr>
                            ...
                            <tbody>
                                {loading ? (
                                    ...
                                    prospeks.map((p, i) => (
                                        <tr key={p.id || i} className="border-b border-gray-50 last:border-0 hover:bg-blue-50/30 transition">
                                            ...
                                            {/* Status */}
                                            <td className="px-3.5 py-2.5">
                                                <span className={`px-2.5 py-0.5 rounded-full text-[11.5px] font-medium ${BADGE[p.lead_status] || "bg-gray-100 text-gray-600"}`}>
                                                    {p.lead_status || "-"}
                                                </span>
                                            </td>
                    ...
                    <div className="flex items-center justify-between px-4 py-2.5 border-t border-gray-100 bg-gray-50">
                        <span className="text-[12px] text-gray-500">
                            Menampilkan {prospeks.length} dari {pagination?.total || 0} Leads
                        </span>
                                ...
                                {Array.from({ length: pagination.last_page }, (_, i) => i + 1)
                                    ...
                                    .map((p, idx, arr) => (
                                        <React.Fragment key={p}>
                                            {idx > 0 && arr[idx - 1] !== p - 1 && (
                                                <span className="w-7 h-7 flex items-center justify-center text-gray-400 text-[12px]">...</span>
                                            )}
                                            <button
